    ...
    {user? (
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
       {/* sign-up form */}
       {
        ...
        {/* sign-in form */}
       <CustomInput control={form.control} name="email" label="Email" placeholder="Enter your email here" />
       <CustomInput control={form.control} name="password" label="Password" placeholder="Enter your password here" />
        <div className="flex flex-col gap-4">
